...
public class AnalysisUtilTest {
    ...
    public void checkRowAppearence_TrueCondition_Success() {
        ...
        boolean result = AnalysisUtil.checkRowAppearence(condition, count).apply(Arrays.asList(2, 4, 6, 8, 10));
    ...
    public void checkRowAppearence_FalseCondition_Failure() {
        Predicate<Integer> condition = num -> num % 2 == 0;
        int count = 3;
        boolean result = AnalysisUtil.checkRowAppearence(condition, count).apply(Arrays.asList(2, 4, 6, 7, 10));
    ...
    public void getAverage_ValidValues_Success() {
        ...
        double result = AnalysisUtil.getAverage(values);
    ...
    public void getSum_ValidValues_Success() {
        Collection<Double> values = Arrays.asList(2.0, 3.0, 4.0);
        double result = AnalysisUtil.getSum(values);
    ...
    public void getAverage_DoubleStream_Success() {
        ...
        double result = AnalysisUtil.getAverage(doubleStream);
    ...
    public void getSum_DoubleStream_Success() {
        DoubleStream doubleStream = DoubleStream.of(2.0, 3.0, 4.0);
        double result = AnalysisUtil.getSum(doubleStream);
        assertEquals(9.0, result, 0.3);
    }
    ...
    public void checkTrendSome_TrueCondition_Success() {
        ...
        int count = 2;
        boolean result = AnalysisUtil.checkTrendSome(condition, count).apply(Arrays.asList(1, 2, 3, 2, 3, 4));
    ...
    public void checkTrendSome_FalseCondition_Failure() {
        BiPredicate<Integer, Integer> condition = (a, b) -> b > a;
        int count = 2;
        boolean result = AnalysisUtil.checkTrendSome(condition, count).apply(Arrays.asList(3, 2, 1, 2, 1, 0));
    ...
    public void checkTrendAll_FalseCondition_Failure() {
        BiPredicate<Integer, Integer> condition = (a, b) -> b > a;
        int count = 2;
        boolean result = AnalysisUtil.checkTrendAll(condition, count).apply(Arrays.asList(1, 2, 3, 2, 3, 2));
